...
exports.run = function (options) {
            ...
            return _regenerator2.default.wrap(function _callee$(_context) {
                while (1) {
                    switch (_context.prev = _context.next) {
                        ...
                        case 15:
                            _context.next = 17;
                            return cleanSourceMaps.bind(this)();
    ...
    function cleanSourceMaps() {
        ...
        function recursiveMove(assetPath, distPath) {
            fs.readdirSync(assetPath).forEach(function (dir) {
                var originPath = sysPath.join(assetPath, dir); // prd/index.js.map
                var newPath = sysPath.join(distPath, dir); // source-map/index.js.map
